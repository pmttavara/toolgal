...
if [%2]==[release] (
  set "args_cl_build=-O2 -DNDEBUG"
  set "args_link_build=-SUBSYSTEM:windows -OPT:REF,ICF=1024"
  set "args_metagen=-DMETAGEN -DMETAGEN_RELEASE"
) else (
  set "args_cl_build=-Od -D_DEBUG"
  set "args_link_build=-SUBSYSTEM:console"
  set "args_metagen=-DMETAGEN"
)

set "args_cl=-nologo -W4 -WX -wd4201 -wd4244 -wd4189 -wd4456 -wd4100 -wd4457 -wd4127 -wd4505 -permissive- -utf-8 !args_cl_build! %cd%/first.c* -Zi -GS- -Gs9999999 -MT -Gm- -GR- -EHa- -Oi -MP -fp:fast"
...
set libs=!sdl_libs! -nodefaultlib "%cd%/lib/*.lib" "Comdlg32.lib"
set "args_link=!libs! !args_link_build! -INCREMENTAL:NO -DEBUG -stack:0x1000000,0x1000000"
if [%1]==[metagen] (
